<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/myboard/skins/default/board.default.css--><?php $__tmp=array('modules/myboard/skins/default/board.default.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/myboard/skins/default/board.default.js--><?php $__tmp=array('modules/myboard/skins/default/board.default.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
